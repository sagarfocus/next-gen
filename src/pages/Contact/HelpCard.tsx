...
const ROWS: HelpRow[] = [
  {
    href: 'tel:+19728481153',
    tag: 'Hotline',
    value: '+1 (972) 848-1153',
    icon: (
      <svg
        width={18}
        height={18}
  ...
  {
    href: 'mailto:hello@thenextgenhealth.com',
    tag: 'Email',
    value: 'hello@thenextgenhealth.com',
    icon: (
      <svg
        width={18}
        height={18}
...
const SOCIALS: SocialLink[] = [
  ...
  {
    href: 'https://twitter.com/thenextgenhealth',
    label: 'X / Twitter',
    icon: (
