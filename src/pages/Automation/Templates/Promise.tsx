    ...
    <div className="container-shell">
      <header className="adv-head det-head">
        ...
        <h2 id="atx-promise-title" className="adv-h2">
          What the library will and will not do.
        </h2>
        <p className="adv-intro">
          Four commitments that hold across every workflow in the library — and across every
          customisation we ship for paying clients too.
        </p>
      </header>
