...
const SOURCES: Source[] = [
  {
    ...
    inputs: ['Google Ads API', 'Meta Marketing API', 'LinkedIn Campaign Manager', 'TikTok Ads + LSA'],
    icon: <AdsIcon />,
  },
  {
    num: '02',
  ...
  },
  {
    ...
    inputs: ['GBP API per location', 'Apple Business Connect', 'Bing Places', 'Geo-grid rank tracker'],
    icon: <GbpIcon />,
  },
  {
    num: '04',
  ...
  },
  {
    ...
    inputs: ['NexHealth / Zocdoc', 'Open Dental + Solutionreach', 'Direct booking widgets', 'Server-side conversion API'],
    icon: <BookIcon />,
  },
  {
    num: '06',
