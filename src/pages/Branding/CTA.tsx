      ...
      <div className="container-shell">
        <div className="br-cta-panel">
          <div className="br-cta-left">
            ...
            <h2 className="br-cta-title">Pressure-test your identity in one session.</h2>
            <p className="br-cta-desc">
              We look at your live touchpoints together - site, ads, social, GBP, signage, intake
              forms - and tell you whether you need a refresh, a rebuild, or just a template kit.
              You leave with a one-page verdict, whether or not we ever work together.
            </p>
