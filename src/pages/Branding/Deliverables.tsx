...
const DELIVERABLES: Deliverable[] = [
  {
    ...
    outputs: ['Primary mark + lockups', 'Color tokens + accessibility pairs', 'Type system (display + body + UI)', 'Photography art direction'],
    icon: <IdentityIcon />,
  },
  {
    num: '02',
    ...
    outputs: ['Positioning statement', 'Voice + tone framework', 'Tagline + 5 headlines', 'Sample copy library'],
    icon: <VoiceIcon />,
  },
  {
    num: '03',
    ...
    outputs: ['Competitive map', 'Audience archetypes', 'Value-prop hierarchy', 'Positioning brief'],
    icon: <PositionIcon />,
  },
  {
    num: '04',
    ...
    outputs: ['Figma design tokens', 'Component library', 'Layout templates', 'Asset naming conventions'],
    icon: <SystemIcon />,
  },
  {
    num: '05',
    ...
    outputs: ['Touchpoint inventory', 'Signage system', 'Print collateral', 'Environmental brand kit'],
    icon: <ExperienceIcon />,
  },
  {
    num: '06',
    ...
    outputs: ['40-60 page guidelines PDF', 'Component-level web reference', 'Voice + tone playbook', 'Quarterly review framework'],
    icon: <GuidelinesIcon />,
  },
];
