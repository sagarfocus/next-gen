    ...
    <div className="container-shell">
      ...
      <div className="mt-8 grid lg:grid-cols-12 gap-x-12 gap-y-12 items-end">
        <div className="lg:col-span-7">
          ...
          >
            A citation programme that consolidates your name, address and phone into a single
            authoritative record — then keeps it that way across the directories search engines
            actually weight.
          </p>
        </div>
