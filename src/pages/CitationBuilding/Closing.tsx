...
import closingImg from '../../assets/our-advantage.png';
    ...
    <div className="container-shell py-[clamp(72px,9vw,128px)]">
      ...
      >
        <div className="p-10 sm:p-14 lg:p-16 flex flex-col justify-center">
          ...
          >
            Yours to keep. The audit returns a ranked remediation register: every duplicate, every
            misspelling, every dormant listing — scored against tier weight. A working document, not
            a slide deck.
          </p>
