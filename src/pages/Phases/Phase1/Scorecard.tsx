const Scorecard = () => (
  <section className="ph1-card-block">
    <div className="ph1-card-text">
      ...
      <h2>
        One scorecard. Every dimension scored against the highest-converting competitor in your
        radius.
      </h2>
      <p>
        Each surface gets a number, a verdict, and a remediation cost. No 80-slide deck - a single
        page your team can act on within an hour of reading it.
      </p>
    </div>
    ...
    <div className="ph1-mock" role="img" aria-label="Audit scorecard preview">
      ...
      <div className="ph1-mock-grid">
        ...
        <div className="ph1-mock-row">
          ...
          <div className="v">
            #7<em className="warn">Below fold</em>
          </div>
          <div className="bar">
            <i style={{ width: '28%' }} />
          </div>
        ...
        <div className="ph1-mock-row">
          ...
          <div className="v">
            12<em className="bad">Missing</em>
          </div>
          <div className="bar">
            <i style={{ width: '12%' }} />
          </div>
        ...
        <div className="ph1-mock-row">
          ...
          <div className="v">
            61<em className="warn">Leaking</em>
          </div>
          <div className="bar">
            <i style={{ width: '61%' }} />
          </div>
