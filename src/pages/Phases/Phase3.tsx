  ...
  return (
    <main className="ph3-root">
      <style>{`
        ...
        .ph3-ccell:last-child { border-right: none; }
        .ph3-ccell .badge {
          display: inline-flex;
          align-items: center;
          gap: 8px;
        ...
        .ph3-handoff li:hover { background: #FFFFFF; }
        ...
        @media (max-width: 900px) {
          ...
          .ph3-cgrid { grid-template-columns: 1fr 1fr; }
          .ph3-ccell:nth-child(2n) { border-right: none; }
          .ph3-ccell { border-bottom: 1px solid rgba(45,55,72,0.18); }
