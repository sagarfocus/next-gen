...
const AREAS: Area[] = [
  {
    ...
    outputs: ['NAP audit + lock', 'Hours + holiday calendar', '40+ attribute fields filled', 'Service-line listings'],
    icon: <ProfileIcon />,
  },
  {
    num: '02',
    ...
    outputs: ['Category map by location', 'Service description copy', 'Service-area cluster strategy', 'Quarterly category review'],
    icon: <CategoryIcon />,
  },
  {
    num: '03',
    ...
    outputs: ['Quarterly shoot day', 'Weekly drip schedule', 'Interior + team + exterior shots', 'Geo-tagged uploads'],
    icon: <PhotoIcon />,
  },
  {
    num: '04',
    ...
    outputs: ['Review-request automation', 'HIPAA-safe response library', '24-hour response SLA', 'Negative review escalation'],
    icon: <ReviewIcon />,
  },
  {
    num: '05',
    ...
    outputs: ['Weekly post calendar', 'Q&A seeding (15-20 entries)', 'Event + offer posts', 'Booking link CTAs'],
    icon: <PostIcon />,
  },
  {
    num: '06',
    ...
    outputs: ['Live dashboard per location', 'Daily anomaly alerts', 'Monthly written retro', 'Booked-revenue attribution'],
    icon: <InsightIcon />,
  },
];
