        ...
        <div className="gb-hero-grid">
          <div>
            ...
            <p className="gb-hero-lede">
              78% of local clicks land on the top-3 Google Map results. We
              engineer your Google Business Profile, citations, reviews,
              posts, and photo cadence to put your clinic - or every clinic
              in your network - at the top. HIPAA-aware moderation, multi-
              location console, named local lead.
            </p>
                ...
                <ul className="gb-hero-result-list">
                  <li className="gb-hero-result active">
                    ...
                    <div className="body">
                      ...
                      <div className="meta">
                        <span className="stars">★★★★★ <em>4.9</em></span>
                        <span className="dist">· 0.4 mi · Open until 9 pm</span>
                      </div>
                      <div className="actions">
                        <span className="ico">
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 2.08 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                          Call
                        </span>
                        <span className="ico">
                  ...
                  <li className="gb-hero-result">
                    ...
                    <div className="body">
                      ...
                      <div className="meta">
                        <span className="stars">★★★★☆ <em>4.6</em></span>
                  ...
                  <li className="gb-hero-result">
                    ...
                    <div className="body">
                      ...
                      <div className="meta">
                        <span className="stars">★★★★ <em>4.3</em></span>
